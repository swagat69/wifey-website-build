...
function BookLink({
  ...
  variant?: "primary" | "ink" | "outline" | "light";
  className?: string;
}) {
  const v =
    variant === "primary"
      ...
      : variant === "ink"
        ...
        : variant === "light"
          ...
          : "btn-outline";
  return (
    <Link to="/booking" className={`btn ${v} ${className}`}>
      {children}
    </Link>
  );
}
...
function SectionLabel({ n, children }: { n: string; children: React.ReactNode }) {
  return (
    <div className="flex items-baseline gap-4">
      <span className="font-display text-sm text-pink">{n}</span>
...
function Hero() {
  return (
    <section className="relative">
      <div className="mx-auto grid max-w-[1400px] gap-10 px-5 pb-14 pt-10 md:px-10 lg:grid-cols-12 lg:gap-14 lg:pb-20 lg:pt-16">
        <div className="lg:col-span-6 lg:pt-6">
          ...
          <p className="mt-7 font-display text-lg tracking-[0.02em] text-ink/70">
          ...
          <p className="lede mt-8 max-w-lg">
            ...
            Imagine coming home to clean floors, a tidy kitchen, fresh beds, folded washing and
            fewer jobs waiting for you.
          </p>
          <p className="lede mt-4 max-w-lg">
            Hire a Wifey provides friendly, reliable household help throughout Hervey Bay. Your
            Wifey can help with cleaning, laundry, ironing, dishes, changing beds, home
            organisation, tidying, meal preparation and the everyday household jobs you never seem
            to have time for.
          </p>
          <p className="lede mt-4 max-w-lg">
            Book us once, every week, every fortnight or whenever you need an extra pair of hands.
            Spend less time doing housework and more time doing what matters to you.
          </p>

          <div className="mt-9 flex flex-wrap gap-3">
            <BookLink>Book a Wifey</BookLink>
    ...
    <section className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
      <div className="grid gap-12 lg:grid-cols-12">
        <Reveal className="lg:col-span-7">
          ...
          <p className="mt-2 font-display text-4xl text-pink md:text-5xl">Or you could Hire a Wifey.</p>
          <p className="lede mt-8 max-w-xl">
            We&apos;re not here to give every customer the exact same cleaning checklist. We&apos;re
            here to ask:
          </p>
          <p className="mt-3 max-w-xl font-display text-2xl italic md:text-3xl">
          ...
          <BookLink className="mt-9">Book a Wifey</BookLink>
        </Reveal>
      ...
      <div className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-5">
            ...
            <p className="mt-8 font-display text-2xl text-white">
        ...
        <Reveal className="mt-16 border-t border-pink pt-10">
          ...
          <BookLink variant="primary" className="mt-9">
            Book your Wifey
          </BookLink>
        </Reveal>
      </div>
    ...
    <section className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
      <div className="grid gap-14 lg:grid-cols-12">
        ...
        <Reveal className="lg:col-span-7" delay={80}>
          ...
          <dl className="mt-12 grid gap-px border border-ink/10 bg-ink/10 sm:grid-cols-2">
            {pillars.map((p) => (
              <div key={p.t} className="bg-cream p-6">
          ...
          <BookLink variant="ink" className="mt-10">
...
function Services() {
  return (
    <section id="services" className="border-y border-ink/10 bg-white">
      <div className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
        <Reveal className="max-w-3xl">
          ...
          <p className="lede mt-7">
            Your Wifey can help with the jobs that matter most to you. Open the ones you&apos;re
            curious about.
          </p>
        </Reveal>
        ...
        <div className="mt-14 border-t border-ink/15">
          {SERVICE_GROUPS.map((g, i) => (
            <details key={g.title} className="group border-b border-ink/15" open={i === 0}>
              <summary className="flex cursor-pointer list-none items-baseline gap-5 py-6 marker:hidden">
                <span className="font-display text-sm text-pink">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <h3 className="font-display text-2xl transition-colors group-hover:text-pink md:text-4xl">
                  {g.title}
                </h3>
                <span className="ml-auto text-xl text-ink/40 transition-transform group-open:rotate-45">
                  +
                </span>
              </summary>
              <div className="pb-8 pl-0 md:pl-[3.1rem]">
        ...
        <BookLink className="mt-12">Book a Wifey</BookLink>
      </div>
    </section>
  );
}
...
function Priorities() {
  ...
  return (
    <section className="relative overflow-hidden bg-blush/70">
      <div className="mx-auto grid max-w-[1400px] gap-12 px-5 py-20 md:px-10 md:py-32 lg:grid-cols-12">
        ...
        <Reveal className="lg:col-span-6" delay={100}>
          <div className="relative mx-auto max-w-md rotate-[-1.2deg] bg-white p-8 shadow-[0_18px_40px_-28px_rgba(0,0,0,0.45)] md:p-10">
            ...
            <ul className="mt-6 space-y-4">
              {list.map((l) => (
                <li key={l} className="flex items-center gap-4 border-b border-ink/10 pb-4">
                  <span
                    aria-hidden
                    className="font-display text-xl leading-none text-pink"
                  >
                    ✓
                  </span>
            ...
            <p className="mt-6 font-display text-lg italic text-ink/50">
...
function WhoWeHelp() {
  return (
    <section id="who-we-help" className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
      <Reveal>
        <SectionLabel n="06">Who we help</SectionLabel>
        <h2 className="display-lg mt-6 max-w-2xl">Who we help</h2>
      </Reveal>

      <div className="mt-14 grid gap-x-14 gap-y-10 md:grid-cols-2">
        {WHO.map((w, i) => (
          <Reveal key={w.t} delay={i * 40} className="border-t border-ink/15 pt-6">
      ...
      <Reveal className="mt-14 border-t-2 border-pink pt-8">
        <h3 className="font-display text-3xl md:text-5xl">Anyone who hates housework.</h3>
        <p className="lede mt-4 max-w-xl">
  ...
  return (
    <section className="border-y border-ink/10 bg-white">
      <div className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
        <div className="grid gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-6">
            <SectionLabel n="07">Regular service</SectionLabel>
            <h2 className="display-lg mt-6">
              Meet your new
              <br />
              favourite day
          ...
          <Reveal className="lg:col-span-6 lg:pt-16" delay={80}>
            <p className="lede">
        ...
        <div className="mt-16 grid gap-px bg-ink/10 md:grid-cols-3">
          {options.map((o, i) => (
            <Reveal key={o.t} delay={i * 60} className="bg-white p-8 md:p-10">
              <span className="font-display text-sm text-pink">0{i + 1}</span>
              <h3 className="mt-4 font-display text-3xl">{o.t}</h3>
...
function WhyChoose() {
  return (
    <section className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
      <div className="grid gap-12 lg:grid-cols-12">
        <Reveal className="lg:col-span-5">
          <SectionLabel n="08">Why us</SectionLabel>
          <h2 className="display-lg mt-6">
            Why choose
            <br />
            Hire a Wifey?
          ...
          <div className="mt-10 border-t-2 border-pink pt-7">
            <p className="font-display text-2xl md:text-3xl">Most importantly, we listen.</p>
            ...
            <BookLink className="mt-8">Book a Wifey</BookLink>
          </div>
        </Reveal>
...
function NdisDva() {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-[1400px] gap-12 px-5 py-20 md:px-10 md:py-28 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-7" delay={70}>
            ...
            <ul className="mt-6 flex flex-wrap gap-x-6 gap-y-2">
              {ndisItems.map((n) => (
                <li key={n} className="text-sm text-ink/70 before:mr-2 before:text-pink before:content-['·']">
                  {n}
                </li>
              ))}
            </ul>
            ...
            <a href="#enquiry" className="btn btn-ink mt-8">
              NDIS enquiry
            </a>
          </Reveal>
        </div>
      ...
      <section id="dva" className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-28">
        <div className="grid gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-5">
            <SectionLabel n="10">DVA</SectionLabel>
            <h2 className="display-md mt-6">
              DVA household
              <br />
              services Hervey Bay
          ...
          <Reveal className="lg:col-span-7" delay={70}>
            ...
            <a href="#enquiry" className="btn btn-outline mt-8">
              DVA enquiry
            </a>
          </Reveal>
        </div>
...
function ServiceArea() {
  return (
    <section id="service-area" className="bg-ink text-white">
      <div className="mx-auto grid max-w-[1400px] gap-12 px-5 py-20 md:px-10 md:py-32 lg:grid-cols-12">
        <Reveal className="lg:col-span-5">
          <SectionLabel n="11">Service area</SectionLabel>
        ...
        <Reveal className="lg:col-span-7" delay={80}>
          <ul className="grid grid-cols-2 gap-x-8 sm:grid-cols-3">
            {SUBURBS.map((s) => (
              <li
                key={s}
                className="border-b border-white/15 py-3 font-display text-lg text-white/85 md:text-xl"
              >
                {s}
              </li>
            ))}
          ...
          <p className="mt-8 max-w-md text-sm leading-relaxed text-white/60">
            ...
            <a href="#enquiry" className="text-pink underline underline-offset-4">
              Make an enquiry
            </a>{" "}
    ...
    <section id="how-it-works" className="border-b border-ink/10 bg-white">
      <div className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
        <Reveal className="max-w-2xl">
          <SectionLabel n="12">The process</SectionLabel>
        ...
        <div className="mt-14">
          {STEPS.map((s, i) => (
            ...
            >
              <span className="font-display text-4xl text-pink md:col-span-2 md:text-6xl">
                {s.n}
              </span>
              <h3 className="font-display text-2xl md:col-span-4 md:text-3xl">{s.t}</h3>
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="mx-auto w-full max-w-[1400px] px-5 md:px-10">
            <div className="max-w-2xl text-white">
              ...
              <p className="mt-6 font-display text-2xl tracking-wide text-pink md:text-3xl">
                We take care of home.
              </p>
...
function Reviews() {
  return (
    <section id="reviews" className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
      <Reveal className="max-w-2xl">
        <SectionLabel n="13">Reviews</SectionLabel>
        <h2 className="display-lg mt-6">
          Don&apos;t just take
          <br />
          our word for it.
      ...
      {REVIEWS.length > 0 ? (
        ...
        <div className="mt-14 border border-dashed border-ink/25 p-10 text-center md:p-16">
          <p className="font-display text-2xl">Real reviews from real Hervey Bay homes.</p>
      ...
      <div className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-32">
        <div className="grid gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            <SectionLabel n="14">Answers</SectionLabel>
            <h2 className="display-md mt-6">
              Frequently
              <br />
              asked questions
            </h2>
            <BookLink className="mt-9 hidden lg:inline-flex">Book a Wifey</BookLink>
          </Reveal>
          ...
          <div className="lg:col-span-8">
              ...
              {FAQS.map((f) => (
                <details key={f.q} className="group border-b border-ink/15">
                  <summary className="flex cursor-pointer list-none items-start gap-5 py-5 marker:hidden">
                    ...
                    <span className="ml-auto shrink-0 text-lg text-ink/40 transition-transform group-open:rotate-45">
                      +
                    </span>
                  </summary>
            ...
            <BookLink className="mt-10 lg:hidden">Book a Wifey</BookLink>
          </div>
        </div>
      </div>
    </section>
...
function Enquiry() {
  return (
    <section id="enquiry" className="bg-blush/70">
      <div className="mx-auto grid max-w-[1400px] gap-12 px-5 py-20 md:px-10 md:py-32 lg:grid-cols-12">
        <Reveal className="lg:col-span-4">
          <SectionLabel n="15">Enquiries</SectionLabel>
          <h2 className="display-md mt-6">
          ...
          <div className="mt-10 space-y-5 border-t border-ink/20 pt-8">
            ...
            <div>
              ...
              <a href={CONTACT.phoneHref} className="mt-1 block font-display text-3xl hover:text-pink">
                {CONTACT.phone}
              </a>
            </div>
          </div>
    ...
    <section className="bg-ink text-white">
      <div className="mx-auto max-w-[1400px] px-5 py-24 md:px-10 md:py-36">
        <Reveal className="max-w-4xl">
          ...
          <p className="mt-2 font-display text-4xl text-white md:text-6xl">
          ...
          <p className="mt-14 font-display text-4xl leading-tight md:text-7xl">
            Hire a Wifey.
            <br />
...
function Recruitment() {
  return (
    <section id="recruitment" className="mx-auto max-w-[1400px] px-5 py-20 md:px-10 md:py-28">
      <Reveal className="grid gap-10 border-t-2 border-pink pt-10 lg:grid-cols-12">
        <div className="lg:col-span-4">
          <SectionLabel n="16">Careers</SectionLabel>
          <h2 className="display-md mt-6">
            Want to become
            <br />a Wifey?
          </h2>
        ...
        <div className="lg:col-span-8">
          ...
          <ul className="mt-6 flex flex-wrap gap-x-6 gap-y-2">
            {[
              ...
              <li key={i} className="text-sm text-ink/70 before:mr-2 before:text-pink before:content-['·']">
                {i}
              </li>
            ))}
          </ul>
          ...
          <p className="mt-6 max-w-2xl text-ink/70">
            <strong className="font-semibold text-ink">Experienced cleaner?</strong> We&apos;d
            especially love to hear from you.{" "}
            <strong className="font-semibold text-ink">No professional experience?</strong>{" "}
            Don&apos;t automatically count yourself out. If you&apos;re enthusiastic, dependable and
            willing to learn, we&apos;d still like to hear from you.
          </p>
          <Link to="/recruitment" className="btn btn-ink mt-9">
            Become a Wifey
          </Link>
        </div>
      </Reveal>
